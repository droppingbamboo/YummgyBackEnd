...
insert into recipe(title, prep_time, favorite_count, ingredients, directions, food_image_url, author)
	values('Beef Burgundy', 30, 3,
...
insert into recipe(title, prep_time, favorite_count, ingredients, directions, food_image_url, author)
	values('Cranberry Curd Tart', 300, 2,
...
insert into recipe(title, prep_time, favorite_count, ingredients, directions, food_image_url, author)
	values('Snowman Cheese Ball', 255, 1,
...
insert into recipe(title, prep_time, favorite_count, ingredients, directions, food_image_url, author)
	values('Gingerbread Bundt Cake', 105, 1,
...
insert into recipe(title, prep_time, favorite_count, ingredients, directions, food_image_url, author)
	values('Loaded Cheesy Green Bean Casserole Recipe', 45, 2,
...
insert into recipe(title, prep_time, favorite_count, ingredients, directions, food_image_url, author)
	values('Mom\'s Potato Latkes', 30, 4,
...
insert into recipe(title, prep_time, favorite_count, ingredients, directions, food_image_url, author)
	values('Perfect Crab-Stuffed Mushrooms', 40, 1,
